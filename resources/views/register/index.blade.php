                        ...
                        <div class="card my-5">
                            <div class="card-body">
                                <div class="d-flex justify-content-center">
                                    <img src="{{ asset('favicon.png') }}" alt="Logo" class="img-fluid"
                                ...
                                <p class="text-center">Register your account <i class="far fa-grin-beam"></i></p>
                                <form action="/register" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('phone') is-invalid @enderror" autofocus
                                                name="phone" id="phone" aria-describedby="emailHelp"
                                                value="{{ old('phone') }}">
                                        </div>
